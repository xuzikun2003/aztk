...
spark.jars                 $spark_home/jars/azure-storage-2.0.0.jar,$spark_home/jars/hadoop-azure-2.7.3.jar,$spark_home/jars/azure-data-lake-store-sdk-2.0.11.jar,$spark_home/jars/hadoop-azure-datalake-3.0.0-alpha4.jar
EOF
...
wget http://central.maven.org/maven2/org/apache/hadoop/hadoop-azure-datalake/3.0.0-alpha4/hadoop-azure-datalake-3.0.0-alpha4.jar
